...
?>
		<div class="ecommerce hero short" style="
			background-image: -webkit-linear-gradient(270deg, rgba(0, 0, 0, .5), rgba(0, 0, 0, .5)), url(<?php echo $image_full; ?>);
		...
		<div class="gray page-section" id="system-overview">
			<div class="centered-content content-wrapper">
				<div class="margin-btm-50 row w-row">
					<div class="col p-left-o w-col w-col-6 w-col-stack"><img alt="<?php echo $industries_image_obj['alt'] ? $industries_image_obj['alt'] : 'This is the image alt'; ?>" title="<?php echo $industries_image_obj['title'] ? $industries_image_obj['title'] : 'This is the image title'; ?>" sizes="(max-width: 479px) 92vw, (max-width: 767px) 90vw, (max-width: 991px) 88vw, 39vw" src="<?php echo $image_800x534; ?>">
					</div>
