...
<div class="hero no-img">
    <div class="bottom content-wrapper">
        <h1 class="page-title-no-hero"><?php the_title(); ?></h1>
        <div class="centered m-btm-30 small-hr"></div>
        <div class="cat-filter-wrap"><a class="cat-filter-item w--current" href="<?php echo home_url('news'); ?>"">All</a>
        <?php
        ...
        ?>
                  <a class="cat-filter-item <?php echo $active; ?>" href="<?php echo get_category_link($category->term_id); ?>">    
...
<div class="gray page-section" id="program-overview">
    <div class="centered-content content-wrapper">
         <div class="news-thumb-row w-row">
        <?php 
            ...
            if ( $the_query->have_posts() ) {
                ...
                while ( $the_query->have_posts() ) {
                    ...
                    $post_image_1000x667 = wp_get_attachment_image_src($post_image, 'industries_1000x667')[0];
                    $post_image_500x334 = wp_get_attachment_image_src($post_image, 'payment500x334')[0];
                    $post_image_800x534 = wp_get_attachment_image_src($post_image, 'industries_800x534')[0];
                    $post_image_obj = wp_prepare_attachment_for_js( $post_image );
                   
                    if ($i%3==0) { 
                        echo '</div><div class="marg-btn-20 row w-row">';
                    }    
            ?> 
            <div class="col no-pad w-col w-col-4">
                <div class="thumb-wrap">
                    <?php if($post_image_1000x667){ ?>
                        <a class="news-thumb-link-block w-inline-block" data-ix="scale-thumb" href="<?php echo get_permalink($post->ID); ?>"><img alt="<?php echo $post_image_obj['alt'] ? $post_image_obj['alt'] : 'This is the image alt'; ?>" title="<?php echo $post_image_obj['title'] ? $post_image_obj['title'] : 'This is the image title'; ?>" class="thumbnail" sizes="(max-width: 767px) 87vw, (max-width: 991px) 27vw, 25vw" src="<?php echo $post_image_1000x667; ?>" srcset="<?php echo $post_image_500x334; ?> 500w, <?php echo $post_image_800x534; ?> 800w, <?php echo $post_image_1000x667; ?> 1000w">
                        </a>
                    <?php } else{ ?>
                        <a class="news-thumb-link-block w-inline-block" data-ix="scale-thumb" href="<?php echo get_permalink($post->ID); ?>"><img alt="placeholder" title="placeholder" class="thumbnail" sizes="(max-width: 767px) 87vw, (max-width: 991px) 27vw, 25vw" src="<?php echo get_template_directory_uri(); ?>/images/placeholder_1000x667.png"  srcset="<?php echo get_template_directory_uri(); ?>/images/placeholder_500x334.png 500w, <?php echo get_template_directory_uri(); ?>/images/placeholder_800x534.png 800w, <?php echo get_template_directory_uri(); ?>/images/placeholder_1000x667.png 1000w">
                        </a>
                    <?php } ?>
